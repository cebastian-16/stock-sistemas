            ...
            <form action="articulo.php" method="post" name="formArticulo">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="placa" id="placa" type="text"
                        pattern="[a-zA-ZÀ-ÿ\u00f1\u00d1\0-9 ]{1,7}" title="Ingrese un numero de Placa valido." required>
                </div>
                <div class="form-group">
                    <label>Descripcion:</label>
                    <input class="form-control" name="descripcion" type="text" pattern="[a-zA-ZÀ-ÿ\u00f1\u00d1\0-9 ]{1,40}"
                        required>
                </div>
                <div class="form-group">
                    <label>Observacion:</label>
                    <input class="form-control" name="observacion" type="text"
                        pattern="[a-zA-ZÀ-ÿ\u00f1\u00d1\0-9 ]{0,120}">
                </div>
                <div class="form-group">
