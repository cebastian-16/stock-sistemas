        ...
        if (!isset($_SESSION['user_id'])) {
            ...
            <?php if (empty($consultaM)) { ?>
                <form action="modificarSimcard.php" method="post" name="ModArticulo">
                    <div class="form-group">
                        ...
                        <input class='form-control' name='lineaM' type='text' pattern='[0-9]{1,11}'
            ...
            <?php if (!empty($consultaM)) { ?>
                <form action="Modificarsimcard.php" method="post" name="formsimcard">
                    ...
                    <div class="form-group">
                        <label>Usuario:</label>
                        <input class="form-control" disabled name="usuario" type="text"
                            value="<?php echo $consultaM["Usuario"] ?>">
                    </div>
                    <div class="form-group">
                        <label>Clave:</label>
                    ...
                    <div class="form-group">
                        ...
                        ?>
                        <input class="form-control" disabled name="operador" type="text"
                            value="<?php echo $resultadoOperador["descripcion"] ?>">
                    </div>
                    <div class="form-group">
                        <label>Observacion:</label>
                        <input class="form-control" maxlength="200" name="observacion" type="text"
                            value="<?php echo $consultaM["Observacion"] ?>">
                    </div>
                    <div class="form-group">
