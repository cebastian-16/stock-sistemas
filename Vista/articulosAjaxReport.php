		...
		<table class="table table-striped table-hover ">
			...
			<tbody>
				...
				foreach ($datos as $key => $row) {
					...
					<tr>
						<!--<td><?= $row['id']; ?></td>-->
						<td><img src="img/1.png" class="avatar" alt="Avatar" style="height: 18px; width: 18px;">
							<?= $row['placa']; ?>
						</td>
						<td>
							<?= $row['descripcion']; ?>
						...
						<td>
							...
							} elseif ($row['descripcion'] == 'torre') {
								echo "<a href='mirarCaracteristica.php?placa=" . $row["placa"] . "' ><svg style='color:blue'  xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-search' viewBox='0 0 16 16'>
				            <path d='M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z'/>
				            </svg>  </a>";
							} elseif ($row['descripcion'] == 'CPU') {
								echo "<a href='mirarCaracteristica.php?placa=" . $row["placa"] . "' ><svg style='color:blue'  xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-search' viewBox='0 0 16 16'>
				            <path d='M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z'/>
				            </svg>  </a>";
							} elseif ($row['descripcion'] == 'TIENDA TAT ') {
								echo "<a href='mirarCaracteristica.php?placa=" . $row["placa"] . "' ><svg style='color:blue'  xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-search' viewBox='0 0 16 16'>
				            <path d='M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z'/>
				            </svg>  </a>";
							}
