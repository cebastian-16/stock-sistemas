        ...
        if (!isset($_SESSION['user_id'])) {
            ...
            <form action="simcard.php" method="post" name="formsimcard">
                <div class="form-group">
                    ...
                    <input class="form-control" name="linea" type="text" pattern="[0-9]{10,15}"
                        title="Ingrese un numero de Linea valido." required>
                </div>
                <div class="form-group">
                    <label>Serie:</label>
                    <input class="form-control" name="serie" type="text" pattern="[0-9]{10,20}"
                        title="Ingrese un numero de Serie valido." required>
                </div>
                <div class="form-group">
                    <label>Usuario:</label>
                    <input class="form-control" name="usuario" type="text" pattern="{0,20}"
                        title="Ingrese un usuario valido." required>
                </div>
                <div class="form-group">
                    <label>Clave:</label>
                    <input class="form-control" name="clave" type="text" pattern="{0,20}" title="Ingrese una clave valida."
                        required>
                </div>
                <div class="form-group">
                    <label>Apn:</label>
                    <input class="form-control" name="apn" type="text" pattern="{0,40}" title="Ingrese una apn valida."
                        required>
                </div>
                <div class="form-group">
                    <label>Plan:</label>
