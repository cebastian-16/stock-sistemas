        ...
        if (!isset($_SESSION['user_id'])) {
            ...
            <form action="usuarios.php" method="post" name="formUsuarios">
                <div class="form-group">
                    <label>Cedula:</label>
                    <input class="form-control" name="cedula" type="text" pattern="[0-9]{7,10}"
                        title="Ingrese un numero de Cedula valido." required>
                </div>
                <div class="form-group">
                    <label>Nombre:</label>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="apellidos" type="text" pattern="[a-zA-ZÀ-ÿ\u00f1\u00d1 ]{1,40}"
                        required>
                </div>
                <div class="form-group">
